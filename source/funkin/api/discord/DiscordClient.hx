...
class DiscordClient
{
  static final CLIENT_ID:String = "1244363525527310367";
  ...
  function buildPresence(params:DiscordClientPresenceParams):DiscordRichPresence
  {
    ...
    presence.largeImageText = "FNF: Project Chorus";
    ...
    presence.largeImageKey = cast(params.largeImageKey, Null<String>) ?? "chorus";
    ...
    presence.smallImageKey = cast(params.smallImageKey, Null<String>) ?? 'icon-face';

    presence.smallImageText = cast(params.smallImageText, Null<String>) ?? 'Opponent';
