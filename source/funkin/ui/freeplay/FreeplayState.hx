...
class FreeplayState extends MusicBeatSubState
{
  ...
  public function new(?params:FreeplayStateParams, ?stickers:StickerSubState)
  {
    ...
    bgDad = new FlxSprite(backingCard.pinkBack.width * 0.74,
      0).loadGraphic(styleData == null ? Paths.image("freeplay/freeplayBGdad") : styleData.getBgAssetGraphic());
  }
